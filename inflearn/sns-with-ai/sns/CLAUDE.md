...
This is a Spring Boot project for a simple SNS (Social Networking Service) like Twitter. It is a web application where users can post messages and see a timeline of posts.
